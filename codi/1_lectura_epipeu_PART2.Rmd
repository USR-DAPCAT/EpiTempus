...
#  bd.dindex=dt_index,
#  finestra.dies=c(-Inf,0),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac0A),
#  prefix="FF.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(-Inf,0),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac0B),
#  prefix="FF.",
#  agregar_data=T,
...
#  bd.dindex=dt_index,
#  finestra.dies=c(-Inf,0),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac0C),
#  prefix="FF.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(-Inf,0),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac0D),
#  prefix="FF.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(0,+Inf),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac1),
#  prefix="FF.EVENT.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(0,+Inf),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac2),
#  prefix="FF.EVENT.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(0,+Inf),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Farmac3),
#  prefix="FF.EVENT.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
...
#  bd.dindex=dt_index,
#  finestra.dies=c(0,+Inf),
#  dt.agregadors=select(dt_cataleg2,cod,agr=agr_Insul_Ado),
#  prefix="FF.EVENT.",
#  agregar_data=T,
#  cataleg_mana = T)%>%select(-dtindex,-`y[FALSE, ]`)
