...
dt_plana<-dt_plana %>% mutate(age=as.numeric(lubridate::ymd(DG.DM2)-lubridate::ymd(dnaix))/365.25)
...
dt_plana<-dt_plana%>%mutate(exclusio1=ifelse(INCLUSIO.DM2>=20070101,0,1))
#dt_plana<-dt_plana%>%mutate(exclusio2=ifelse(dtindex>=entrada & dtindex<=sortida ,0,1))
