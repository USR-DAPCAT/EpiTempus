...
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FF.EVENT.Metformina=ifelse(is.na(FF.EVENT.Metformina),100000000,FF.EVENT.Metformina))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.pioglitazona=ifelse(is.na(FF.EVENT.pioglitazona),100000000,FF.EVENT.pioglitazona))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.Sulfonilureas=ifelse(is.na(FF.EVENT.Sulfonilureas),100000000,FF.EVENT.Sulfonilureas))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.Glinides=ifelse(is.na(FF.EVENT.Glinides),100000000,FF.EVENT.Glinides))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.ISGLT2=ifelse(is.na(FF.EVENT.ISGLT2),100000000,FF.EVENT.ISGLT2))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.IDPP4=ifelse(is.na(FF.EVENT.IDPP4),100000000,FF.EVENT.IDPP4))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.aGLP1=ifelse(is.na(FF.EVENT.aGLP1),100000000,FF.EVENT.aGLP1))  
dt_plana<-dt_plana%>%mutate(FF.EVENT.Insul=ifelse(is.na(FF.EVENT.Insul),100000000,FF.EVENT.Insul))  




#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Metformina=ifelse  (
                                                               FF.EVENT.Metformina<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.Metformina<=FF.EVENT.Glinides  &
                                                               FF.EVENT.Metformina<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.Metformina<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.Metformina<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.Metformina<=FF.EVENT.Insul,FF.EVENT.Metformina,NA)) 
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Metformina=ifelse(FIRST_FF.EVENT.Metformina==100000000,NA,FIRST_FF.EVENT.Metformina))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.pioglitazona=ifelse(FF.EVENT.pioglitazona<=FF.EVENT.Metformina  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.Glinides  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.pioglitazona<=FF.EVENT.Insul,FF.EVENT.pioglitazona,NA))  
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.pioglitazona=ifelse(FIRST_FF.EVENT.pioglitazona==100000000,NA,FIRST_FF.EVENT.pioglitazona))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Sulfonilureas=ifelse(FF.EVENT.Sulfonilureas<=FF.EVENT.Metformina  &
                                                              
                                                               FF.EVENT.Sulfonilureas<=FF.EVENT.Glinides  &
                                                               FF.EVENT.Sulfonilureas<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.Sulfonilureas<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.Sulfonilureas<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.Sulfonilureas<=FF.EVENT.Insul,FF.EVENT.Sulfonilureas,NA)) 
dt_plana<-dt_plana%>%mutate(FF.EVENT.Sulfonilureas=ifelse(FF.EVENT.Sulfonilureas==100000000,NA,FF.EVENT.Sulfonilureas))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Glinides=ifelse(    FF.EVENT.Glinides<=FF.EVENT.Metformina  &
                                                               
                                                               FF.EVENT.Glinides<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.Glinides<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.Glinides<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.Glinides<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.Glinides<=FF.EVENT.Insul,FF.EVENT.Glinides,NA))  
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Glinides=ifelse(FIRST_FF.EVENT.Glinides==100000000,NA,FIRST_FF.EVENT.Glinides))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.ISGLT2=ifelse(      FF.EVENT.ISGLT2<=FF.EVENT.Metformina  &
                                                               
                                                               FF.EVENT.ISGLT2<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.ISGLT2<=FF.EVENT.Glinides  &
                                                               FF.EVENT.ISGLT2<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.ISGLT2<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.ISGLT2<=FF.EVENT.Insul,FF.EVENT.ISGLT2,NA))
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.ISGLT2=ifelse(FIRST_FF.EVENT.ISGLT2==100000000,NA,FIRST_FF.EVENT.ISGLT2))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.IDPP4=ifelse(       FF.EVENT.IDPP4<=FF.EVENT.Metformina  &
                                                               
                                                               FF.EVENT.IDPP4<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.IDPP4<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.IDPP4<=FF.EVENT.Glinides  &
                                                               FF.EVENT.IDPP4<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.IDPP4<=FF.EVENT.Insul,FF.EVENT.IDPP4,NA))
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.IDPP4=ifelse(FIRST_FF.EVENT.IDPP4==100000000,NA,FIRST_FF.EVENT.IDPP4))  
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.aGLP1=ifelse(             FF.EVENT.aGLP1<=FF.EVENT.Metformina  &
                                                               
                                                               FF.EVENT.aGLP1<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.aGLP1<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.aGLP1<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.aGLP1<=FF.EVENT.Glinides  &
                                                               FF.EVENT.aGLP1<=FF.EVENT.Insul,FF.EVENT.aGLP1,NA))
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.aGLP1=ifelse(FIRST_FF.EVENT.aGLP1==100000000,NA,FIRST_FF.EVENT.aGLP1))  

#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Insul=ifelse(             FF.EVENT.Insul<=FF.EVENT.Metformina  &
                                                              
                                                               FF.EVENT.Insul<=FF.EVENT.Sulfonilureas  &
                                                               FF.EVENT.Insul<=FF.EVENT.ISGLT2  &
                                                               FF.EVENT.Insul<=FF.EVENT.IDPP4  &
                                                               FF.EVENT.Insul<=FF.EVENT.aGLP1  &
                                                               FF.EVENT.Insul<=FF.EVENT.Glinides,FF.EVENT.Insul,NA))
dt_plana<-dt_plana%>%mutate(FIRST_FF.EVENT.Insul=ifelse(FIRST_FF.EVENT.Insul==100000000,NA,FIRST_FF.EVENT.Insul))  
...
#dt_plana %>% select(FFF.A10BD15,FFF.A10BD16,FFF.A10BD20)
...
dt_plana<-dt_plana %>% mutate_at(var_a_factoritzar,~factor(.,levels = c(0,1),labels = c("No","Si")))
